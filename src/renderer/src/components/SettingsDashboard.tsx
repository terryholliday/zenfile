    ...
    return (
        <div className="max-w-4xl mx-auto p-8 space-y-8">
            ...
            <section className="space-y-4">
                <h3 className="text-lg font-semibold text-indigo-400 uppercase tracking-wider text-xs">Scan Criteria</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-neutral-800/50 p-6 rounded-lg border border-neutral-700">
                        ...
                        <p className="text-xs text-neutral-500 mb-4">Files explicitly older than this will be flagged.</p>
                        <input
                            type="number"
            ...
            {/* Safety */}
            <section className="space-y-4">
                <h3 className="text-lg font-semibold text-emerald-400 uppercase tracking-wider text-xs">Safety</h3>
            ...
            {/* Excluded Paths */}
            <section className="space-y-4">
                <h3 className="text-lg font-semibold text-red-400 uppercase tracking-wider text-xs">Excluded Paths</h3>
                <div className="bg-neutral-800/50 p-6 rounded-lg border border-neutral-700 space-y-4">
                    <p className="text-sm text-neutral-400">These folders will be completely ignored during scans.</p>
                    ...
                    <ul className="space-y-2 max-h-48 overflow-y-auto">
                        {settings.excludePaths.map((path) => (
                            <li key={path} className="flex items-center justify-between bg-neutral-900/50 px-3 py-2 rounded border border-neutral-800 group">
